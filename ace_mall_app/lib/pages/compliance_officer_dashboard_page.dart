...
class ComplianceOfficerDashboardPage extends StatefulWidget {
  const ComplianceOfficerDashboardPage({super.key});

  @override
  State<ComplianceOfficerDashboardPage> createState() => _ComplianceOfficerDashboardPageState();
}

class _ComplianceOfficerDashboardPageState extends State<ComplianceOfficerDashboardPage> {
  ...
  Future<void> _verifyAccessAndLoadData() async {
    try {
      ...
      if (roleName == null || !roleName.contains('Compliance Officer')) {
        // Unauthorized access - redirect to signin
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Unauthorized access. You must be a Compliance Officer.'),
